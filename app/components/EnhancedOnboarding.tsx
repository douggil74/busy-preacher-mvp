...
export function EnhancedOnboarding({ isOpen, onComplete }: EnhancedOnboardingProps) {
  ...
  const [step, setStep] = useState(0); // Start at 0 for Google sign-in
          ...
          {step === 0 && (
            <div className="space-y-6 text-center">
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Sign in with Google to access personalized features like Ask the Pastor and Prayer Community
              </p>
