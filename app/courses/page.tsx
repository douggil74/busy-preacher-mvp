    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-100 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white">
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="text-center sm:text-left mb-16">
          <h1 className={cn(playfair.className, typography.h1, 'mb-4 text-slate-900 dark:text-white')}>
            Study Courses
          </h1>
          ...
          {Object.entries(groupedCourses).map(([category, categoryCourses]) => (
            <div key={category}>
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className={cn(playfair.className, typography.h2, 'text-slate-900 dark:text-white')}>
                  {getCategoryName(category)}
                </h2>
                <div className="flex-1 h-px bg-gradient-to-r from-slate-300 dark:from-white/20 to-transparent" />
              </div>
                ...
                {categoryCourses.map((course) => {
                  ...
                  return (
                    <Link
                      ...
                      className="relative group rounded-3xl overflow-hidden bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-sm hover:border-yellow-400/40 transition-all duration-300 shadow-lg"
                    >
                      ...
                      <div className="relative p-6">
                        <div className="flex items-start gap-5 mb-4">
                          <div className="text-4xl flex-shrink-0 w-14 h-14 rounded-xl bg-slate-200 dark:bg-white/10 border border-slate-300 dark:border-white/10 flex items-center justify-center">
                            {getCategoryIcon(category)}
                          </div>

                          <div className="flex-1 min-w-0">
                            <h3
                              className={`${playfair.className} text-xl font-bold text-slate-900 dark:text-white mb-1 group-hover:text-yellow-400 transition-colors`}
                            >
                              {course.title}
                            </h3>
                            {course.subtitle && (
                              <p className="text-sm text-slate-500 dark:text-white/50">{course.subtitle}</p>
                            )}
                          </div>
                        </div>
                        ...
                        {/* Course Meta */}
                        <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500 dark:text-white/50 mb-4">
                        ...
                        {hasStarted ? (
                          <div>
                            <div className="flex items-center justify-between text-xs mb-2">
                              <span className="text-slate-600 dark:text-white/60 font-medium">In Progress</span>
        ...
        <div className="text-center mt-24">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-slate-600 dark:text-white/60 hover:text-yellow-400 transition-colors"
          >
            <svg
              className="w-4 h-4"
              fill="none"
