...
export function getPastorNote(): string {
  const notes = [
    ...
    // Pastor Doug's teachings from Spiritual Foundations
    ...
    "Prayer and Scripture intake are daily essentials for growth. -PD",
    "Consistency beats intensity — build a habit. -PD",
    "God's Word nourishes, guides, corrects, and equips you. -PD",
    ...
    "Repentance is a change of mind that changes life. -PD",
    "God's kindness and godly sorrow lead us to repent. -PD",
    "Baptism is a command for disciples, following repentance and faith. -PD",
    "It powerfully portrays our union with Christ. -PD",
    "Baptism marks a break with the old and a beginning of the new. -PD",
    "Laying on of hands is biblical and multifaceted. -PD",
    "Exercise discernment, humility, and love. -PD",
    ...
    "Worship is God-centered and Scripture-shaped. -PD",
    "Both heart and body can express adoration. -PD",
    "Corporate worship builds up the church and glorifies God. -PD",
    "You are gifted by God for the good of others. -PD",
    "Gifts flourish through service, feedback, and faithfulness. -PD",
    "Love governs all gift use. -PD",
    "The Spirit's empowering is a gift for effective witness. -PD",
    ...
    "Eternal perspective reshapes priorities and mission. -PD",
    ...
    "Marriage mirrors Christ and the church. -PD",
    "Healthy homes grow from sacrificial love and mutual honor. -PD",
    "Families are disciple-making outposts. -PD",
    "Stewardship is worship — God first. -PD",
    "Generosity, wisdom, and contentment mark kingdom finance. -PD",
